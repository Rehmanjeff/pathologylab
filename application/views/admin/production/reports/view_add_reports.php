            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_title">
                    <h2>Add New Report <small>Patient</small></h2>
                    
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" action="<?php echo base_url(); ?>admin/add_report" data-parsley-validate class="form-horizontal form-label-left" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" required="required" name="report_name" placeholder="Report Name" class="form-control col-md-7 col-xs-12" />
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <?php if (!empty($patients)) 
                          {
                      		...
                      		{ ?>
                          		<option value="<?php echo $patient->patient_id; ?>"><?php echo $patient->patient_firstname." ".$patient->patient_lastname; ?>
                          		</option>
                          	<?php
                          	}
                          } ?>
    ...
    <script type="text/javascript">
        ...
        $( function(){ 
            ...
            {    
              ...
              var state = $.ajax({
                url: "<?php echo base_url()."admin/get_record_by_id/"; ?>"+patient_id,
                type: "POST",
                data: {id : patient_id, get : "tests"},
                dataType: "text"
              });
